    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['date_commande', 'numero_commande', 'code_magasin'], name='asten_comma_date_co_cd3631_idx'), models.Index(fields=['date_commande'], name='asten_comma_date_co_5db08b_idx'), models.Index(fields=['code_magasin'], name='asten_comma_code_ma_c35000_idx')],
